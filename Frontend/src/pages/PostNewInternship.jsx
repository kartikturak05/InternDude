...
const PostNewInternship = () => {
  ...
  return (
    <>
      <div className="max-w-6xl mx-auto pt-4 pb-2 text-4xl font-bold">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-8 bg-white p-6 rounded-lg shadow border border-gray-200">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                {formData.otherBenefits.map((perk, index) => (
                  <span
                    key={index}
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        const newPerks = [...formData.otherBenefits];
                        newPerks.splice(index, 1);
                        setFormData({ ...formData, otherBenefits: newPerks });
                      }}
              ...
              {/* Dropdown for predefined perks */}
              <select
                onChange={(e) => {
                  const value = e.target.value;
                  if (value && !formData.otherBenefits.includes(value)) {
                    setFormData({
                      ...formData,
                      otherBenefits: [...formData.otherBenefits, value],
                    });
                  }
              ...
              >
                ...
                <option value="Pre-placement Offer">Pre-placement Offer</option>
                <option value="Laptop">Laptop</option>
                <option value="Flexible Hours">Flexible Hours</option>
              </select>

              {/* Custom input for typing own perk */}
              <input
                type="text"
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    e.preventDefault();
                    const customPerk = e.target.value.trim();
                    if (
                      customPerk &&
                      !formData.otherBenefits.includes(customPerk)
                    ) {
                      setFormData({
                        ...formData,
                        otherBenefits: [...formData.otherBenefits, customPerk],
                      });
                    }
                    e.target.value = "";
                  }
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              onClick={() =>
                navigate("/employer/PostOpportunity/PreviewInternship")
              }
            >
              Preview Internship
            </button>
