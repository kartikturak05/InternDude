        ...
        <div className="relative px-6 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start w-full space-y-4 md:space-y-0">
            <div className="flex flex-col md:flex-row items-center md:items-end w-full md:w-auto text-center md:text-left">
              <div className="relative -mt-10 md:-mt-16 md:mr-4">
                <img
                  ...
                  alt="John Anderson"
                  className="w-20 h-20 md:w-20 md:h-20 rounded-full border-4 border-white shadow-md"
                />
              </div>
              <div>
                <h1 className="text-xl md:text-2xl font-bold">John Anderson</h1>
                <p className="text-gray-600 text-sm md:text-base">
                  Senior UX/UI Designer
                </p>
                <div className="flex flex-wrap justify-center md:justify-start items-center text-xs md:text-sm mt-2">
                  <MdLocationOn className="text-gray-500 mr-1" />
                  <span className="text-gray-600 mr-3">San Francisco, CA</span>
            ...
            <div className="flex space-x-2 w-full md:w-auto justify-center md:justify-end">
              <button className="bg-blue-500 text-white px-3 md:px-4 py-2 rounded-md text-sm flex items-center">
                <FaPlus className="mr-1" /> Download Resume
              </button>
              <button
                className="border border-gray-300 text-gray-700 px-3 md:px-4 py-2 rounded-md text-sm hover:bg-gray-100"
          ...
          <div className="w-full md:w-2/3 p-6">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                user-centered designs for web and mobile platforms. Specialized
                in design systems, interaction design, and user research.
                Currently working new opportunities in innovative tech
                companies.
              </p>
              ...
              <div className="mb-6 flex">
                ...
                <div>
                  ...
                  <p className="text-gray-700 mt-2">
                    Led the redesign of core products resulting in 40% increase
                    in user engagement. Managed a team of 3 designers.
                  </p>
                </div>
              </div>
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-gray-600 text-sm">
                      Complete redesign of an e-commerce platform focusing on
