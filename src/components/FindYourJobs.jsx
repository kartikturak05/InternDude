    ...
    <div className=" pt-12 mb-30 w-auto">
      <div className="flex flex-col items-center justify-center h-[440px] ">
        <div className="flex flex-row items-center justify-around ">
          <div className="">
            <div className="text-5xl font-bold mb-10 mr-40">
          ...
          <div className="w-auto h-auto mt-7 ">
            <img src="personmodel.png" alt="" className="w-[308px] h-[359px]"/>
          </div>
        </div>
        <div className="flex flex-col items-start justify-between w-auto bg-gray-200 pt-5 pl-40 pr-40 pb-5 mt-10">
