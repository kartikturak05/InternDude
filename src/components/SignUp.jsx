...
const SignUp = () => {
  ...
  const handleAuth = async () => {
    ...
    try {
      if (isSignup) {
        ...
        toast.info("After verifying your email, you can sign in with your credentials.");
  ...
  return (
    <div className="h-auto sm:p-20 w-full flex justify-center">
      <div className="flex flex-col sm:flex-row justify-around items-center w-full max-w-5xl pl-10 rounded-2xl shadow-lg"
        style={{
