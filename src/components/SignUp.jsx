    ...
    <div className="h-auto sm:p-20 w-full flex justify-center ">
      ...
      >
        ...
        <div className="w-full sm:w-1/2 flex flex-col items-center bg-transparent p-6 rounded-lg pb-10 pt-10">
          ...
          {/* Continue Button */}
          <button className="flex items-center justify-center bg-violet-900 text-white font-semibold text-base py-3 mt-6 w-full rounded-xl hover:bg-violet-800 cursor-pointer">
